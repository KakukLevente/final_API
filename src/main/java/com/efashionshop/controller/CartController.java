...
public class CartController {
	...
	@PutMapping("/add")
	public CartItem addItemToCart(@RequestBody AddItemRequest req, @RequestHeader("Authorization")String jwt)throws UserException, ProductException{

		User user = userService.findUserProfileByJwt(jwt);
		return cartService.addCartItem(user.getId(), req); 
	}
